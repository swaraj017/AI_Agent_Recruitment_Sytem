    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-foreground items-center justify-center p-12">
        <div className="max-w-sm text-background">
          <h1 className="text-3xl font-semibold mb-4">Find Your Perfect Match</h1>
          <p className="text-background/70 mb-8">
            AI-powered recruitment platform that connects talented candidates with the right opportunities.
          </p>
          <div className="space-y-3 text-sm text-background/80">
            <p>• Smart resume matching</p>
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-9 bg-foreground text-background font-medium rounded-md hover:bg-foreground/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm mt-1"
            >
