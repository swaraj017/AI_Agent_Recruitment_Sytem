          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  View and manage all applicants across jobs
                </p>
              </div>
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <select
                ...
                className="px-4 py-2.5 rounded-lg border border-border text-sm bg-card focus:border-foreground focus:ring-1 focus:ring-foreground/10 outline-none"
              >
            ...
            <div className="flex-1 flex gap-6 min-h-0">
              {/* Candidates Grid */}
              <div
                className={`flex-1 overflow-y-auto scrollbar-hide ${selectedCandidate ? "w-2/3" : "w-full"}`}
              >
                  ...
                  <Card className="sticky top-0">
                    ...
                    <div
                      className={`p-4 rounded-xl mb-4 ${
                        selectedCandidate.atsScore >= 80
                          ? "bg-green-50"
                          : selectedCandidate.atsScore >= 60
                            ? "bg-yellow-50"
                            : "bg-red-50"
                      }`}
                    >
